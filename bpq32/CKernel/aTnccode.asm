...
_ENDOFDATA	DD	0		; For DUMP ROUTINE
	...
	EXTRN	_PORTTABLE:DWORD,_NUMBEROFPORTS:WORD, _pgm:BYTE
	...
	EXTRN	_QCOUNT:WORD,_IDMSG_Q:DWORD
...
;
	...
	EXTRN	_CloseSessionPartner:NEAR,CONVFROMAX25:NEAR
	EXTRN	GETBUFF:NEAR,RELBUFF:NEAR,_Q_ADD:NEAR,Q_REM:NEAR

EXTRN	_SENDSABM:NEAR

	EXTRN	GETPORTTABLEENTRY:NEAR
