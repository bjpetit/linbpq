...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case IDUMDF:
			...
			OutputLine("Adding User Mode Device - Plase wait");
			InstallUMDF();
			OutputLine("Add User Mode Device Complete");
			return 0;
...
int cmdUpdate()
{
	char inf[300] = "BPQvirtualserial.inf";
	char hwid[] = "UMDF\\BPQVirtualSerial";
