...
#define Vers 6,0,11,8
#define Verstring "6.0.11.8\0"
#define Datestring "October 2015"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.11.8\0"
...
#define Vers 1,4,64,6
#define Verstring "1.4.64.6\0"
