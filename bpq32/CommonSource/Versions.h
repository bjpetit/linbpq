...
#define Vers 6,0,7,13
#define Verstring "6.0.7.13\0"
#define Datestring "May 2014"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.7.13\0"
...
#define Vers 1,4,60,4
#define Verstring "1.4.60.4\0"
