...
#define Vers 6,0,7,2
#define Verstring "6.0.7.2\0"
#define Datestring "April 2014"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.7.2\0"
...
#define Vers 1,4,60,1
#define Verstring "1.4.60.1\0"
