...
#define Vers 6,0,9,16
#define Verstring "6.0.9.16\0"
#define Datestring "December 2014"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.9.16\0"
...
#define Vers 1,4,62,4
#define Verstring "1.4.62.4\0"
