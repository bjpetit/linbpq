...
#define Vers 6,0,9,34
#define Verstring "6.0.9.34\0"
#define Datestring "February 2015"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.9.34\0"
...
#define Vers 1,4,62,7
#define Verstring "1.4.62.7\0"
