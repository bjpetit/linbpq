...
#define Vers 6,0,4,1
#define Verstring "6.0.4.1\0"
#define Datestring "October 2013"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.4.1\0"
...
#define Vers 1,4,57,1
#define Verstring "1.4.57.1\0"
