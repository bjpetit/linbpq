...
#define Vers 6,0,11,1
#define Verstring "6.0.11.1\0"
#define Datestring "September 2015"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.11.1\0"
...
#define Vers 1,4,64,1
#define Verstring "1.4.64.1\0"
