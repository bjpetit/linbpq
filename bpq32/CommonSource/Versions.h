...
#define Vers 6,0,10,1
#define Verstring "6.0.10.1\0"
#define Datestring "February 2015"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.10.1\0"
...
#define Vers 1,4,63,1
#define Verstring "1.4.63.1\0"
