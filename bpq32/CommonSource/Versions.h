...
#define Vers 6,0,8,39
#define Verstring "6.0.8.39\0"
#define Datestring "November 2014"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.8.39\0"
...
#define Vers 1,4,61,9
#define Verstring "1.4.61.9\0"
