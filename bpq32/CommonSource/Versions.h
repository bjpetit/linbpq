...
#define Vers 6,0,4,44
#define Verstring "6.0.4.44\0"
#define Datestring "December 2013"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.4.44\0"
...
#define Vers 1,4,57,9
#define Verstring "1.4.57.9\0"
