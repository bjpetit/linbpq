...
#define Vers 6,0,10,22
#define Verstring "6.0.10.22\0"
#define Datestring "April 2015"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.10.22\0"
...
#define Vers 1,4,63,9
#define Verstring "1.4.63.9\0"
