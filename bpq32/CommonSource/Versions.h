...
#define Vers 6,0,8,6
#define Verstring "6.0.8.6\0"
#define Datestring "September 2014"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.8.6\0"
...
#define Vers 1,4,61,4
#define Verstring "1.4.61.4\0"
