...
#define Vers 6,0,9,31
#define Verstring "6.0.9.31\0"
#define Datestring "January 2015"
#define VerComments "G8BPQ Packet Switch (C Version) V6.0.9.31\0"
...
#define Vers 1,4,62,6
#define Verstring "1.4.62.6\0"
