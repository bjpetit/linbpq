...
HARDWAREDATA	DB	96 DUP (?)	; WORK AREA FOR HARDWARE DRIVERS
...
L2RESEQ_Q	DD	?		; FRAMES RECEIVED OUT OF SEQUENCE
...
NEIGHBOUR_LINK	DD	?		; POINTER TO LINK FOR THIS NEIGHBOUR
...
KBBUFFER	DD	?		; BUFFER ALLOCATED TO KEYBOARD
KBSESSION	DD	?		; POINTER TO L4 SESSION ENTRY FOR CONSOLE
;		DD	14 DUP (?)	; 14 MORE SESSIONS FOR HOST MODE PORT
MSGLEN		DW	?
