...
CRCTAB	DW	0,1189H,2312H,329BH,4624H
...
;
	...
	EXTRN	_ASYINIT:NEAR,_ASYSEND:NEAR,_POLLKISS:NEAR
...
;
	EXTRN	Q_ADD:NEAR,Q_REM:NEAR,RELBUFF:NEAR,GETBUFF:NEAR
...
CHECK_CHECKSUM:
	...
	MOV	CX,5[EDI]		; LENGTH, INCLUDING SUM
	CMP	CX,13H
...
FOUNDIT:
	...
	CALL	Q_ADD			; PUT ON PORT RX QUEUE
...
;
	MOV	CX,5[EDI]		; MSG LENGTH
	SUB	CX,7			; HEADER LENGTH
	ADD	EDI,7
...
;
	...
	MOV	EDX,LINKS
	SUB	DWORD PTR BUFFLEN-4[ESI],EDX	; CAN ONLY SEND 2 BOTES TO TNC
	SETATVEC TXHDDR1
...
;
	...
	TEST	KISSFLAGS[EBX],POLLINGKISS
	JZ SHORT POLLRESP		; MUST BE SENDING POLL RESPONSE
