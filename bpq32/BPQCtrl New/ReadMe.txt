========================================================================
		OLE Control DLL : BPQCTRL
========================================================================

ControlWizard has created this project for your BPQCTRL OLE Control DLL,
...
that make up your BPQCTRL OLE Control DLL.
...
BPQCtrlCtl.h
	This file contains the declaration of the CBPQCtrlCtrl C++ class.

BPQCtrlCtl.cpp
	This file contains the implementation of the CBPQCtrlCtrl C++ class.

BPQCtrlPpg.h
	This file contains the declaration of the CBPQCtrlPropPage C++ class.

BPQCtrlPpg.cpp
	This file contains the implementation of the CBPQCtrlPropPage C++ class.

BPQCtrlCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CBPQCtrlCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file BPQCtrl.rc.

/////////////////////////////////////////////////////////////////////////////
Help Support:

MakeHelp.bat
	Use this batch file to create your OLE control's Help file, BPQCtrl.hlp.
