...
_ENDOFDATA	DD	0		; For DUMP ROUTINE
	...
	EXTRN	REALTIMETICKS:WORD,_BUFFERWAITS:DWORD
...
;	Action any DISC Requests (must be done in timer owning process)
	...
	TEST	HOSTFLAGS[EBX],40H		; DISC REQUEST
	JZ short CheckTraceQ
	
	TEST	HOSTFLAGS[EBX],20H		; STAY?
	JZ short @F

	MOV	DISCFLAG,'S'
@@:		
	
	AND	HOSTFLAGS[EBX],10011111B	; Clear Flags
