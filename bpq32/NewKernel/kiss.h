...
#define PORTVECTOR( x ) (x -> Portvector)
#define RXVECTOR( x ) (x -> RXvector)
...
BOOL NEAR WriteTTYBlock( int, LPSTR, int ) ;
int NEAR ReadCommBlock( int, LPSTR, int ) ;
