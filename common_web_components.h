...
#define COMMON_HTML_CANONICAL_DYNAMIC "<link rel=\"canonical\" id=\"bpqCanonical\" href=\"/\"><script>(function(){var l=document.getElementById('bpqCanonical');if(l&&window.location){l.href=window.location.origin+window.location.pathname;}})();</script>"
