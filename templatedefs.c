...
char * WebMailPagetxt()
{
	char Msg[] =
		...
		".msg-table{width:100%%;min-width:720px;border-collapse:collapse;font-size:13px;}"
		...
		".msg-date{min-width:80px;font-size:12px;}"
		...
		".msg-table{min-width:0;font-size:12px;}"
		".msg-table thead{display:none;}"
		".msg-table,.msg-table tbody,.msg-table tr,.msg-table td{display:block;width:100%%;}"
		".msg-table tr.msg-row{border:1px solid var(--border);border-radius:8px;background:var(--surface);margin:0 0 8px 0;padding:6px;}"
		".msg-table tr.msg-row:hover{background:#f8fafc;}"
		".msg-table td{white-space:normal;overflow:visible;text-overflow:clip;border-bottom:none;padding:4px 2px;max-width:none;}"
		".msg-table td::before{content:attr(data-label);display:inline-block;min-width:64px;font-weight:600;color:#475569;margin-right:6px;}"
		".msg-table td.msg-type,.msg-table td.msg-len,.msg-table td.msg-via{display:none;}"
		".msg-to,.msg-from,.msg-subject{max-width:none;}"
		"}"
		"</style>\r\n"
