...
char * WebMailPagetxt()
{
	static const char Msg[] =
		...
		".msg-num{font-family:monospace;}"
		".msg-date{font-family:monospace;}"
		".msg-type{font-family:monospace;min-width:24px;}"
...
char * ChatConfigtxt()
{
	static const char Msg[] =
		...
		"#main form{font-family:monospace;text-align:left;}"
		"#main input[type=text],#main input[type=number],#main input:not([type]),#main textarea{border:1px solid var(--border);border-radius:6px;padding:8px 10px;box-sizing:border-box;font-family:monospace;}"
		"#main input[type=text],#main input:not([type]){max-width:100%%;}"
		"#main textarea{width:100%%;resize:vertical;}"
		".chatcfg-title{text-align:center;font-family:monospace;font-size:18px;font-weight:700;margin:6px 0 0;}"
