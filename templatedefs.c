...
char * WebMailMsgtxt()
{
	char Msg[] =
		...
		"body{margin:0;padding:12px;font-family:-apple-system,BlinkMacSystemFont,\"Segoe UI\",Arial,sans-serif;background:var(--bg);color:var(--text);min-height:100dvh;}"
		...
		".menu-toggle:focus-visible,.wm-btn:focus-visible{outline:2px solid var(--primary);outline-offset:2px;}"
		...
		"@media (max-width:768px){body{padding:8px;}.wm-shell{min-height:calc(100dvh - 16px);}.menu .wm-btn{width:100%%;text-align:center;}#main{padding:10px;}textarea#txt{min-height:240px;font-size:13px;}div#txt{min-height:240px;font-size:13px;}}"
		"</style>\r\n"
		"<script>"
		...
		"<a class=\"wm-btn\" href=/WebMail/Reply/%d?%s>Reply</a>"
...
char * WebMailPagetxt()
{
	char Msg[] =
		...
		COMMON_MENU_CSS
		".menu{margin-bottom:10px;}"
		".menu-toggle:focus-visible,.menu a:focus-visible,.msg-table tr.msg-row:focus-visible{outline:2px solid var(--primary);outline-offset:2px;}"
		...
		".msg-table-hint{display:none;margin:0 0 8px;font-size:12px;color:#475569;}"
		".msg-table-wrap{width:100%%;overflow-x:auto;-webkit-overflow-scrolling:touch;}"
		".msg-table{width:100%%;min-width:640px;border-collapse:collapse;font-size:13px;}"
		...
		".msg-table td{padding:8px 6px;text-align:left;border-bottom:1px solid #e2e8f0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}"
		".msg-table tr.msg-row{cursor:pointer;}"
		".msg-table tr.msg-row[role=link]:focus-visible{background:#eef2f7;}"
		...
		".msg-num{text-align:left;font-family:monospace;}"
		".msg-date{font-family:monospace;}"
		".msg-type{text-align:left;font-family:monospace;min-width:24px;}"
		".msg-len{text-align:left;font-family:monospace;min-width:50px;}"
		...
		".msg-table-hint{display:block;}"
		".msg-table{min-width:560px;font-size:12px;}"
		".msg-table th,.msg-table td{padding:6px 4px;}"
		".msg-date{min-width:44px;font-size:12px;}"
		...
		".msg-table{min-width:460px;font-size:11px;}"
		".msg-table th,.msg-table td{padding:4px 3px;}"
		".msg-date{min-width:44px;}"
		".msg-num{min-width:18px;}"
		".msg-type{min-width:18px;}"
		".msg-to,.msg-from{max-width:44px;}"
		".msg-subject{max-width:96px;}"
		"}"
		"</style>\r\n"
		...
		"<a href=/WebMail/NewMsg?%s>Send Message</a>\r\n"
		"<a href=/WebMail/WMLogout?%s>Logout</a>\r\n"
		"<a href=/Mail/Header>Mail Mgmt</a>\r\n"
		"<a href=/>Node Menu</a>"
		"</nav>"
		"<div id=\"main\">\r\n"
		"<p class=\"msg-table-hint\">Swipe left/right to view all columns.</p>\r\n"
		"<div class=\"msg-table-wrap\">%s</div>\r\n"
		"</div> \r\n"
		"</div>"
		"</body></html>";
		"\r\n"
