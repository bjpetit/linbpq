...
char * Housekeepingtxt()
{
	static const char Msg[] =
		...
		".hk-form-row input[type=text],.hk-form-row input[type=number]{flex:0 0 80px;padding:6px;border:1px solid var(--border);border-radius:6px;}"
		...
		".hk-table input{width:60px;padding:5px;border:1px solid var(--border);border-radius:6px;}"
		...
		".hk-textarea-grid textarea{width:100%%;min-height:120px;padding:8px;border:1px solid var(--border);border-radius:6px;font-family: " COMMON_FONT_MONO ";font-size:clamp(0.9375rem,0.9rem + 0.2vw,1rem);resize:vertical;}"
		".hk-buttons{display:flex;gap:10px;justify-content:center;margin-top:20px;flex-wrap:wrap;}"
		".hk-buttons input{background:var(--primary);color:var(--on-primary);padding:10px 20px;border:none;border-radius:6px;cursor:pointer;min-height:44px;font-size:clamp(1rem,0.94rem + 0.25vw,1.125rem);}"
