...
char * FwdPagetxt()
{
	static const char Msg[] =
		...
		".fwd-form-row input[type=text], .fwd-form-row input[type=number] { flex: 2 1 100px; padding: clamp(10px,1vw,14px) clamp(12px,1.5vw,16px); line-height: 1.5; box-sizing: border-box; border: 1px solid var(--border); border-radius: 4px; max-width: 200px; min-height: 44px; font-size: clamp(0.875rem,2vw,1rem); }"
		".fwd-form-row input[type=checkbox] { margin: 0 5px; width: 18px; height: 18px; }"
		".fwd-form-row textarea { width: 100%%; padding: clamp(10px,1vw,14px) clamp(12px,1.5vw,16px); line-height: 1.6; box-sizing: border-box; border: 1px solid var(--border); border-radius: 4px; font-family: " COMMON_FONT_MONO "; font-size: clamp(0.875rem,2vw,1rem); min-height: 120px; resize: vertical; }"
...
char * Housekeepingtxt()
{
	static const char Msg[] =
		...
		".hk-textarea-grid textarea{width:100%%;min-height:120px;padding:8px;border:1px solid var(--border);border-radius:4px;font-family: " COMMON_FONT_MONO ";font-size:clamp(0.9375rem,0.9rem + 0.2vw,1rem);resize:vertical;}"
		".hk-buttons{display:flex;gap:10px;justify-content:center;margin-top:20px;flex-wrap:wrap;}"
		".hk-buttons input{background:var(--primary);color:var(--on-primary);padding:10px 20px;border:none;border-radius:4px;cursor:pointer;min-height:44px;font-size:clamp(1rem,0.94rem + 0.25vw,1.125rem);}"
