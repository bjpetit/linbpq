...
Public Class AEASIM
   ...
   Private Sub AEASIM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

      Dim Access As Long = &HC0000000

      SerHandle = CreateFile("\\.\bpq104", Access And &HFFFFFFFF, _
   ...
   Sub ProcessMessage(ByVal Msg() As Byte)
      ...
      If Msg(Msg.Length - 1) = 13 Then
         Dim MsgString As String = GetString(Msg)

         If InStr(MsgString, "HOST  Y") > 0 Then
            Return
         Else
            PutMessage("cmd: " & vbCr)
            Exit Sub
      ...
      If Msg(Msg.Length - 1) = 23 Then   'ETB
