...
Public Class Form1
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        ("HKEY_LOCAL_MACHINE\Software\G8BPQ\BPQ32", "BPQ Directory", "c:\")
...
loop1:   LineNo = LineNo + 1
   ...
   End Function
    ...
    Public Sub ProcessTextPort()
        ...
        ReDim Preserve Config(PortConfigPointer + 512)
        ...
        For p = 1 To NumofPortConfigParams
            ...
            If TxtPortCfg(p).LineNo(SavePortNo) = 0 Then ' Not specified
                ...
                If p = PORTNUM Then
                    ...
                    If TxtPortCfg(PORTNUM).Value(SavePortNo) <> SavePortNo Then
