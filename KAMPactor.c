...
static int WebProc(struct TNCINFO * TNC, char * Buff, BOOL LOCAL)
{
	...
	Len += sprintf(&Buff[Len], "<table style=\"text-align: left; width: 480px; font-family: 'JetBrains Mono', 'Fira Code', 'Source Code Pro', Consolas, Monaco, 'Courier New', monospace; align=center \" border=1 cellpadding=2 cellspacing=2>");
