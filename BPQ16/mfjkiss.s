...
SIO	EQU	11011100B	; 0DCH - A5 = CHIP SEL

SPEED	EQU	10111111B	; A6 = SPEED LATCH
CONFIG	EQU	01111111B	; A7 = CONFIG LATCH
	
PRINT	EQU	11101111B	; A4 = PRINTER PORT (NOT USED)
...
VERSION:
	DEFM	'MFJBPQK APR93'	;13 BYTES (EXACTLY!) HERE FOR VERSION STRING
...
;
;	SET MFJ CONFIG LATCHES
;
	LD	A,01010000B		; TERM=9600 HDLC=1200
	OUT	(SPEED),A

	LD	A,00100011B		; PORT 1 PACKET VHF
	OUT	(CONFIG),A
...
NO_ID:
	...
	LD	A,00100111B		; PORT 1 PACKET VHF CW KEY 
	OUT	(CONFIG),A
